...
IF ~!PartyHasItemIdentified("a7#cvtx") !AreaType(A7_RUBIKON)~ Unidentified.2
...
IF ~!PartyHasItemIdentified("a7#cvtx") AreaType(A7_RUBIKON)~ Unidentified.1
  SAY @8001 /* The cube vibrates slightly in your hands. You have no idea what it could be used for. */
  ++ @8008 /* Put the cube away. */ EXIT
END

IF ~PartyHasItemIdentified("a7#cvtx") !AreaType(A7_RUBIKON)~ Identified.1
...
IF ~PartyHasItemIdentified("a7#cvtx") AreaType(A7_RUBIKON)~ Identified.2
