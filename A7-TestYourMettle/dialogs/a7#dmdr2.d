// Modron Worker (identical with a7#dmdr1.d)

BEGIN ~a7#dmdr2~

IF ~Global("A7#ModronRIntro","GLOBAL",0)~ Intro.R
  SAY @3001 /* You see a cube with four arms and two legs sprouting from its sides. On the front of the cube is an animated face. As you approach, the creature focuses its eyes upon you. */
  IF ~~ DO ~SetGlobal("A7#ModronRIntro","GLOBAL",1)~ + 1
END

IF ~!Global("A7#ModronRIntro","GLOBAL",0)~ 1
  SAY @3500 /* Greetings. */
